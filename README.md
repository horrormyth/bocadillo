...
The migration file generated by Orator should look as follows:
...
In `.up()`, you can see that the post's ID and timestamps (`created_at`, `updated_at`) have already been specified. We can add more columns ourselves:
